                ...
                <div class="row">
                    <div class="col-xxl-12">
                        <nav aria-label="breadcrumb" class="breadcrumb-list-2 pt-0">
                            <div class="block2 lii"><a href="../index.php" class="linktext ml-70">Главная</a><div class="linetext1" style="margin-left: 7px;">></div><div class="linetext1" style="margin-left: 7px;">Восстановить пароль</div></div>
                          </nav>
                    </div>
                </div>
            </div>
                  ...
                  <div class="col-lg-8 offset-lg-2">
                        <div class="basic-login">
                           ...
                           <form method="post" action="updatepass.php">
                              <label for="name">Почта<span>**</span></label>
                              <input id="name" type="text" name="login" placeholder="Введите почту..." />
